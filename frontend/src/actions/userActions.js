...
import { 
 ...
 export const logout = () => (dispatch) => {
    localStorage.removeItem('userInfo');  // remove the user from local storage
    dispatch({ type: USER_LOGOUT })
    dispatch({ type: USER_DETAILS_RESET})      // dispatch a logout action to clear the user data from state
};
